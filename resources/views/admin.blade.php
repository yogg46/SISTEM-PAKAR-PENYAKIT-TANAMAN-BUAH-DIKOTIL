...
@section('page')
    ...
    <script>
        ...
        var colors = ['rgba(255, 99, 132, 0.5)', 'rgba(54, 162, 235, 0.5)', 'rgba(255, 206, 86, 0.5)', 'rgba(75, 192, 192, 0.5)', 'rgba(153, 102, 255, 0.5)', 'rgba(20, 159, 64, 0.5)','rgba(255, 19, 64, 0.5)','rgba(255, 159, 164, 0.5)'];
        var bgcolors = ['rgba(255, 99, 132, 0.1)', 'rgba(54, 162, 235, 0.1)', 'rgba(255, 206, 86, 0.1)', 'rgba(75, 192, 192, 0.1)', 'rgba(153, 102, 255, 0.1)', 'rgba(20, 159, 64, 0.1)','rgba(255, 19, 64, 0.1)','rgba(255, 159, 164, 0.1)'];
